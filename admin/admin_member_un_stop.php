...
<div class="shadow-lg p-4 mb-4 bg-white">
    ...
    <?php
        ...
        <div class="col-md-4 md-3 pt-3">
            <div class="card">
                ...
                <div class="card-footer">
                    <a onclick="return confirm('คุณต้องการจะยกเลิกการระงับข้อมูลใช่หรือไม่')" href="?id=<?= $value['Member_id']; ?>" class="btn btn-warning">ยกเลิกระงับ</a>
                </div>
            </div>
        </div>
        ...
        if (isset($_GET['id'])) {
            ...
            if ($update) {
                echo "<script>window.location='member_un_stop.php'</script>";
            }
        }
